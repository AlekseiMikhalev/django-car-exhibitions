...
const Footer = () => {
  return (
    <footer className="bg-white inset-x-0 md:flex md:justify-between p-4 md:p-6 xl:p-8 my-6 mx-4 bottom-0">
      <ul className="flex items-center flex-wrap md:mb-0">
        <li>
          <a
            href="#"
            className="text-sm font-light text-gray-500 hover:underline mr-4 md:mr-6"
          >
